...
{
  char autodesc;   // make desc. out of NONE field for right,left,both,skip (def:1)
...
int main(int argc,char *argv[])
{
 ...
 // setup options.
 options.autodesc   = 1;     // automatic description
 options.debuglevel = optdebugval | optdebugpos;     // values
 options.outdebug   = 1;
