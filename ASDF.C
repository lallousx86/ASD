/* *************************************************
   ...
   *  version : v1.0.4                             *
   *  compiler: borland c++ 3.x                    *
   *  coder   : elias_bachaalany@yahoo.com         *
   *************************************************
   ...
   ========
      ...
      11:55AM 04/03/1999 - fixed a bug in last line
			   it was printed twice
      05:56PM 04/09/1999 - fixed file_exist routine (made it more compatible)
      10:28PM 04/15/1999 - fixed pre_line()
      06:21PM 09/15/2000 - code re-visit and browsing
      11:50AM 03/04/2001 - code re-visit and browsing
*/
		    ...
		    char *optcharlist,char *optformat)
{
  ...
  // optcharcount = option char list len (eg:"ado"=3)
 ...
 if (j==errnomem)
  {
   ...
   cprintf(" þ Allocating %d byte(s) for pre buffers\n\x0D",j);
   #endif
